...
import type { CarteiraRequest, Assessoria } from '../../types';

const EMPTY: CarteiraRequest = { nome: '', descricao: '', situacao: 'Ativo', assessoriaId: 0 };
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={3}
              placeholder="Descricao da carteira"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Assessoria <span className="text-red-500">*</span>
            </label>
            <select
              name="assessoriaId"
              value={form.assessoriaId || ''}
              onChange={handleChange}
              required
